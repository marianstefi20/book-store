...
public class RequestUtil {
    ...
    public static String getSessionCurrentOrderNr(Request request) {
        try {
            String val = request.session().attribute("orderNr").toString();
            return val;
    ...
    public static void resetSessionCurrentOrderNr(Request request) {
